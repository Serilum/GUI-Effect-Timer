...
public class Util {
    public static void addEffectTimer(GuiGraphics guiGraphics, MobEffectInstance mobEffectInstance, int k, int l) {
        ...
        guiGraphics.drawString(font, timeText, (int)(((k + 13) / scale) - (font.width(timeText) / 2.0F)), (int)(((l + 16) / scale)), ARGB.color(255, ConfigHandler.timerColourRGB_R, ConfigHandler.timerColourRGB_G, ConfigHandler.timerColourRGB_B), true);
